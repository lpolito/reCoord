...
import { useIsPlaying, usePlayerSetters } from './player-provider';
...
export const Player = ({ clip, startTime = null, ...props }: PlayerProps) => {
  const isTimeProgressing = useIsPlaying();
  const { addPlayer, setPlaying: setTimeProgressing } = usePlayerSetters();
